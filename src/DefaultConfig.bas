...
Sub DefaultConfig()
    ...
    With gVim.KeyMap
        ...
        'Filter
        .Map "nmap qq ToggleAutoFilter"
        .Map "nmap qd ClearCurrentColumnFilter"
        .Map "nmap qD ClearAllFilters"
        .Map "nmap q* FilterByActiveCellValue"
        .Map "nmap qb FilterByBlanks"
        .Map "nmap q<Space> FilterByBlanks"
        .Map "nmap qB FilterByNonBlanks"
        .Map "nmap q<S-Space> FilterByNonBlanks"
        .Map "nmap q/ ShowFilterDialog"
        .Map "nmap qo FilterByAboveAverage"
        .Map "nmap qu FilterByBelowAverage"
        .Map "nmap q== FilterByInputEquals"
        .Map "nmap qe FilterByInputEquals"
        .Map "nmap q!= FilterByInputNotEquals"
        .Map "nmap qn FilterByInputNotEquals"
        .Map "nmap q<< FilterByInputLessThan"
        .Map "nmap qlt FilterByInputLessThan"
        .Map "nmap q>> FilterByInputGreaterThan"
        .Map "nmap qgt FilterByInputGreaterThan"
        .Map "nmap q<= FilterByInputLessEqual"
        .Map "nmap q=< FilterByInputLessEqual"
        .Map "nmap qle FilterByInputLessEqual"
        .Map "nmap q>= FilterByInputGreaterEqual"
        .Map "nmap q=> FilterByInputGreaterEqual"
        .Map "nmap qge FilterByInputGreaterEqual"
        .Map "nmap q^ FilterByInputBeginsWith"
        .Map "nmap qS FilterByInputBeginsWith"
        .Map "nmap q$ FilterByInputEndsWith"
        .Map "nmap qE FilterByInputEndsWith"
        .Map "nmap q!^ FilterByInputNotBeginsWith"
        .Map "nmap q!S FilterByInputNotBeginsWith"
        .Map "nmap q!$ FilterByInputNotEndsWith"
        .Map "nmap q!E FilterByInputNotEndsWith"
        .Map "nmap qi FilterByInputContains"
        .Map "nmap qI FilterByInputNotContains"
        .Map "nmap qt FilterByTopNItems"
        .Map "nmap qw FilterByBottomNItems"
        .Map "nmap q%t FilterByTopNPercent"
        .Map "nmap q%w FilterByBottomNPercent"
        .Map "nmap qsa Sort 1"
        .Map "nmap qsd Sort 2"
        .Map "nmap qsc SortColor"
